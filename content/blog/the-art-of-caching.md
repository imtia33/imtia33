...
date: "2026-09-09"
description: "A question about permission, a hidden number, and the delta-sync strategy that came out of being broke. How I cut Appwrite database reads by 66x on TravX with no budget and no edge cache."
excerpt: "A question about permission, a hidden number, and the strategy that came out of being broke. How I cut Appwrite database reads by 66x using delta sync on a local mirror — no budget, no edge cache, no ISG."
tags: ["appwrite", "caching", "delta-sync", "performance", "react-native", "travx"]
...
keywords:
  - appwrite caching
  - delta sync
  - appwrite reads limit
  - local database mirror
  - react native offline cache
  - appwrite performance optimization
  - reduce database reads
  - $updatedAt bookmark sync
---

# The Art of Caching

*A question about permission, a hidden number, and the strategy that came out of being broke.*
